...
public class FiltrosItem {
    public static Target INPUT_PRECIO_VALOR_MINIMO = Target.the("input valor minimo de precio").located(By.id("low-price"));
    public static Target INPUT_PRECIO_VALOR_MAXIMO = Target.the("input valor maximo de precio").located(By.id("high-price"));
